...
public class Main extends Application {
    ...
    public enum PropertyType {
        ...
        /* GAME TEXT */
        SPLASH_SCREEN_TITLE_TEXT, GAME_TITLE_TEXT, GAME_SUBHEADER_TEXT, WIN_DISPLAY_TEXT, YES_TEXT, NO_TEXT, DEFAULT_YES_TEXT, DEFAULT_NO_TEXT, DEFAULT_EXIT_TEXT, PLAYER_TEXT, COMPUTER_TEXT, NAME_TEXT, NUM_PLAYERS_TEXT, POINTS_TEXT, ROLL_AGAIN_TEXT,
        /* IMAGE FILE NAMES */
        WINDOW_ICON, SPLASH_SCREEN_IMAGE_NAME, START_BUTTON, LOAD_BUTTON, ABOUT_BUTTON, QUIT_BUTTON, BACK_BUTTON, HISTORY_BUTTON, ROLL_BUTTON, FLIGHT_BUTTON, GO_BUTTON, LOGO_IMG, PLAYER_ICON, PLAYER_FLAG, FLAG, MAP_IMG, DIE_IMG,
        /* AUDIO FILE NAME */
        THEME_AUDIO,
        /* TOOLTIPS */
