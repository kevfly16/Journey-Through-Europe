...
public class Main extends Application {
    ...
    public enum PropertyType {
        ...
        /* HTML FILE NAMES */
        ABOUT_FILE_NAME, HISTORY_FILE_NAME, DEFAULT_FILE_NAME,
        /* DATA FILE NAMES */
        CITIES_FILE, FLIGHTS_FILE, CARDS_FILE, CONNECTIONS_FILE, SAVE_FILE, MOVE_SAVE_FILE,
        /* GAME TEXT */
        SPLASH_SCREEN_TITLE_TEXT, GAME_TITLE_TEXT, GAME_SUBHEADER_TEXT, WIN_DISPLAY_TEXT, YES_TEXT, OK_TEXT, NO_TEXT, DEFAULT_YES_TEXT, DEFAULT_NO_TEXT, DEFAULT_EXIT_TEXT, FLIGHT_DISPLAY_TEXT, SCORE_DISPLAY_TEXT, PLAYER_TEXT, COMPUTER_TEXT, NAME_TEXT, NUM_PLAYERS_TEXT, POINTS_TEXT, ROLL_AGAIN_TEXT, SAVE_DISPLAY_TEXT,
        /* IMAGE FILE NAMES */
        WINDOW_ICON, SPLASH_SCREEN_IMAGE_NAME, START_BUTTON, LOAD_BUTTON, SAVE_BUTTON, ABOUT_BUTTON, QUIT_BUTTON, BACK_BUTTON, HISTORY_BUTTON, ROLL_BUTTON, FLIGHT_BUTTON, GO_BUTTON, LOGO_IMG, PLAYER_ICON, PLAYER_FLAG, FLAG, MAP_IMG, FLIGHT_IMG, DIE_IMG, END_BUTTON,
        /* AUDIO FILE NAME */
        THEME_AUDIO,
        /* TOOLTIPS */
